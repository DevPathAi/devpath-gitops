...
class Prod27R4CloudflareDirectUploadFixPublishTest(unittest.TestCase):
    @classmethod
    ...
    def test_exact_release_coordinates_are_pinned(self) -> None:
        for value in (
            ...
            "d117b476d58a8f34cea94e9ac2472e673144ea1c",
            "ce21141303f05c24209b5de7cb52bae271a66e0d",
            "801bf75f47e5c8af67627a3a9ab6fc1f72b414a9",
            "chore/prod27r4-cloudflare-direct-upload-fix-publish",
