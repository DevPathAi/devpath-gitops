...
class Prod26r7ValidationDispatchTest(unittest.TestCase):
    @classmethod
    ...
    def test_branch_dispatcher_is_exact_and_actions_only(self) -> None:
        ...
        for expected in (
            "if: github.ref == 'refs/heads/chore/prod26r7-validate-dispatch'",
            "RELEASE_ID: ms-20260829-prod26r7",
            "SOURCE_SHA: eca2a73378eff8a9ce310f7ef997b51b7910984f",
            "actions: write",
            "contents: read",
