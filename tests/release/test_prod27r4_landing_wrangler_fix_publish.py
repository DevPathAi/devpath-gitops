...
class Prod27R4LandingWranglerFixPublishTest(unittest.TestCase):
    @classmethod
    ...
    def test_exact_release_coordinates_are_pinned(self) -> None:
        for value in (
            ...
            "chore/prod27r4-landing-wrangler-fix-publish-20260911",
            "fix/landing-wrangler-trust-boundary-main-20260911",
        ):
    ...
    def test_chain_is_authenticated_before_and_after_publish(self) -> None:
        ...
        for fragment in (
            ...
            'test "$(sed -n \'s/^landing_direct_upload_source_fix_commit=//p\' "$before_output")" = "$MAIN_SHA"',
